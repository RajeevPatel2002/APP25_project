...
<body>
    <div class="admin-batch-container">
        ...
        <div class="admin-batch-button">
            <a href="multiplefile.php" class="admin-batch-bLink">Create New Data</a>
        </div>
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            ?>
                                <img height="50px" width="50px" style=" border-radius:50% ; border:2px solid #000"; src="../upload/<?= $photos ?>">
                                <?php
                                }
                                ?>
                                </td>
                                ...
                                <td class="admin-batch-tableData">
                                    ...
                                    <a href="delete2.php?id=<?= $record['id'] ?>">
