        ...
        <div class="contact-form">
            <form action="read2.php" class="contact-form-container" method="post">
                <div class="contact-header-box">
                    <h2 class="contact-log-header">Send a Message</h2>
                </div>

                <div class="contact-input-box">
                    <label for="name" class="contact-log-lebel">Name</label>
                    <i class="fa-solid fa-envelope contact-icon"></i>
                    <input type="text" id="name" name="name" class="contact-log-input"  placeholder="Name">
                </div>

                <div class="contact-input-box">
                    <label for="email" class="contact-log-lebel">E-mail</label>
                    <i class="fa-solid fa-lock contact-icon"></i>
                    <input type="email" id="email" name="email" class="contact-log-input"  placeholder="Email">
                </div>
                <div class="contact-input-box">
                    <label for="password" class="contact-log-lebel">Message</label>
                    <i class="fa-solid fa-message"></i>
                    <textarea name="message" id="message" cols="20" rows="3" class="contact-log-input" placeholder="Enter message here" ></textarea>
                </div>

                <div class="contact-button">
                    <button class="contact-login-button">Send Message</button>
                </div>
