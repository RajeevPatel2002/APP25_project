...
//  }
//  $sql="Create table student(id int(20) primary key auto_increment, name varchar(20),email varchar(50),phone int(12))";
...
// }
// $sql="insert into student(id,name,email,phone)values(1'Rajeev','Rajeev@gmail.com',9889828629)";
// $sql="insert into student(id,name,email,phone)values('patel','patel@gmail.com',9889822019)";
// $sql="insert into student(id,name,email,phone)values('Rajeev patel','Rpatel@gmail.com',9889827339)";
// $sql="insert into student(id,name,email,phone)values('verma Rajeev','verma@gmail.com',9889261909)";
// $sql="insert into student(id,name,email,phone)values('chaudhary Rajeev','chaudhary@gmail.com',9889828929)";
...
<!-- ===================================================== -->
<?php
$connect=mysqli_connect('localhost','root','','rajeevpatel');
